...
const BM_SHARED_I18N = {
  ru: {
    ...
    mode_classic_d: "Одна бомба, один взрыв — у кого рванёт, тот проиграл",
    ...
    first_out: "Первым рвануло у: {name}",
    sec_s: "{s} с",
  ...
  en: {
    ...
    mode_classic_d: "One bomb, one blast — whoever holds it loses",
