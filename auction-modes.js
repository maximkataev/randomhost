...
const MODES = [
  ...
  },
  {
    ...
    byKind: {
      artist: { title: "Супергруппа зла", short: "Группа, чей тур закончится захватом мира", judge: "решает, чей состав быстрее подомнёт планету" },
      person: { title: "Синдикат зла", short: "Знаменитости, которые поделят мир между собой", judge: "решает, чей синдикат и правда захватит мир" },
      ...
      animal: { title: "Звериная орда", short: "Звери, которые подомнут человечество", judge: "решает, чья орда страшнее для человечества" },
      club: { title: "Лига зла", short: "Клубы, которые заберут весь спорт себе", judge: "решает, чья лига подомнёт мировой спорт" },
      company: { title: "Корпорация зла", short: "Корпорации, которые тайно правят миром", judge: "решает, чей холдинг быстрее скупит планету" },
    ...
    t: {
      en: {
        ...
        byKind: {
          artist: { title: "Evil Supergroup", short: "A band whose tour ends in world domination", judge: "decides whose line-up conquers the planet faster" },
          person: { title: "Evil Syndicate", short: "Celebrities who carve up the world between them", judge: "decides whose syndicate really takes over" },
          ...
          animal: { title: "Beast Horde", short: "Animals that put humanity back in its place", judge: "decides whose horde humanity should fear most" },
          club: { title: "League of Evil", short: "Clubs that take the whole sport hostage", judge: "decides whose league owns world sport" },
          company: { title: "Evil Corporation", short: "Corporations that secretly run the world", judge: "decides whose holding buys the planet first" },
      ...
      el: {
        ...
        byKind: {
          artist: { title: "Συγκρότημα του κακού", short: "Μπάντα που θα υποτάξει τον κόσμο σε μια περιοδεία", judge: "κρίνει ποιο λάιναπ υποτάσσει πιο γρήγορα τον πλανήτη" },
          person: { title: "Συνδικάτο του κακού", short: "Διάσημοι που θα μοιράσουν τον κόσμο μεταξύ τους", judge: "κρίνει ποιο συνδικάτο παίρνει όντως τον κόσμο" },
          ...
          animal: { title: "Ορδή των ζώων", short: "Ζώα που θα βάλουν την ανθρωπότητα στη θέση της", judge: "κρίνει ποια ορδή τρομάζει πιο πολύ την ανθρωπότητα" },
          club: { title: "Λίγκα του κακού", short: "Σύλλογοι που θα πάρουν όλο το άθλημα δικό τους", judge: "κρίνει ποια λίγκα ορίζει το παγκόσμιο άθλημα" },
          company: { title: "Εταιρεία του κακού", short: "Εταιρείες που κυβερνούν κρυφά τον κόσμο", judge: "κρίνει ποιος όμιλος αγοράζει πρώτος τον πλανήτη" },
  ...
  },
  {
    ...
    byKind: {
      ...
      city: { title: "Где пересидеть", short: "Города, в которых есть шанс дожить до весны", judge: "считает, где выживают, а где едят друг друга" },
    ...
    t: {
      en: {
        ...
        byKind: {
          ...
          city: { title: "Where to Sit It Out", short: "Cities where you might live to see the spring", judge: "works out where you survive and where you get eaten" },
      ...
      el: {
        ...
        byKind: {
          ...
          city: { title: "Πού θα κρυφτείς", short: "Πόλεις όπου έχεις ελπίδα να δεις άνοιξη", judge: "υπολογίζει πού επιβιώνεις και πού σε τρώνε" },
  ...
  },
  {
    ...
    byKind: {
      artist: { title: "Кто играет на пати", short: "Кто выступает у тебя до самого утра", judge: "выбирает, у кого танцевали до рассвета" },
      ...
      animal: { title: "Звери на пати", short: "Гости с лапами, копытами и клыками", judge: "выбирает, у кого зверинец веселее" },
      painting: { title: "Картины на стенах", short: "Чем завесить стены, чтобы все залипли", judge: "выбирает, чьи стены сделали атмосферу" },
      company: { title: "Кто платит за пати", short: "Спонсоры, которые оплатят весь банкет", judge: "выбирает, чья корпоративка вышла легендарной" },
      club: { title: "Афтерпати с клубом", short: "С чьими фанатами гулять после матча", judge: "выбирает, у кого празднование веселее" },
      profession: { title: "Пати-команда", short: "Спецы, которые вытянут любой праздник", judge: "выбирает, чья команда устроила лучший вечер" },
      invention: { title: "Гаджеты для пати", short: "Гаджеты, без которых вечеринка не та", judge: "выбирает, чьи штуковины сделали вечер" },
    },
    t: {
      en: {
  ...
  },
  {
    ...
    byKind: {
      artist: { title: "Музей музыки", short: "Музыканты под стеклом, как экспонаты", judge: "выбирает, в чей зал потащат друзей" },
    ...
    t: {
      en: {
        ...
        byKind: {
          artist: { title: "Museum of Music", short: "Musicians behind glass, like exhibits", judge: "picks the hall people drag their friends to" },
      ...
      el: {
        ...
        byKind: {
          artist: { title: "Μουσείο μουσικής", short: "Μουσικοί σε προθήκη, σαν εκθέματα", judge: "διαλέγει σε ποια αίθουσα φέρνουν και τους φίλους" },
  ...
  },
  {
    ...
    byKind: {
      ...
      food: { title: "Ужин для короля", short: "Чем накормить средневековый двор", judge: "решает, чей стол взорвёт прошлое" },
      ...
      animal: { title: "Зверь для прошлого", short: "Кого выпустить в средневековый лес", judge: "решает, чьи звери сильнее наследят в истории" },
    ...
    t: {
      en: {
        ...
        byKind: {
          ...
          food: { title: "Dinner for a King", short: "What you feed a medieval court", judge: "decides whose table blows the past away" },
          ...
          animal: { title: "Beast for the Past", short: "What you set loose in a medieval forest", judge: "decides whose animals leave the bigger mark" },
      ...
      el: {
        ...
        byKind: {
          ...
          food: { title: "Δείπνο για βασιλιά", short: "Τι θα σερβίρεις σε μεσαιωνική αυλή", judge: "κρίνει ποιο τραπέζι σαρώνει το παρελθόν" },
          ...
          animal: { title: "Θηρίο στο παρελθόν", short: "Τι θα αφήσεις λυτό στο μεσαιωνικό δάσος", judge: "κρίνει ποια ζώα αφήνουν το μεγαλύτερο σημάδι" },
